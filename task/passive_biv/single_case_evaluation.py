...
class FEHeartSimSageEvaluation(FEHeartSimSageTrainDataset):
    ...
    def __init__(self, data_config: Dict, idx: int = 1) -> None:
    ...
    def _init_transform(self):
        ...
        norm_config = {
            ...
            "stress": self._stress_stats_path,
        }
    ...
    def _load_model(self) -> nn.Module:
        ...
        """
        model = torch.load(
            f"{self._base_repo_path}/log/passive_biv/final_v1/model/model.pth",
...
if __name__ == "__main__":
    ...
    config.task_data["data_type"] = "test"
    # config.task_data["model_name"] = "fe_heart_sim_sage"
    # config.task_data["task_data_path"] = "/home/lshi/Work/phy_gnn_v2/data/passive_biv"

    evaluation = FEHeartSimSageEvaluation(config.task_data, 1)
